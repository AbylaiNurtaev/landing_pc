...
const FAQ_DATA: FAQItem[] = [
  {
    id: '1',
    question: 'Это казино?',
    answer: 'Нет, это программа лояльности. Баллы начисляются за посещения.',
  },
  {
    id: '2',
    question: 'Можно ли вывести деньги?',
    answer: 'Нет, призы применяются только внутри клуба.',
  },
  {
    id: '3',
    question: 'Законно ли это?',
    answer: 'Да, это маркетинговый инструмент, не азартная игра.',
  },
  {
    id: '4',
    question: 'Как формируется призовой фонд?',
    answer: 'Клуб сам настраивает призы и вероятности.',
  },
]
